(function () {
  ...
  var GREET = [
    ...
    [
      ...
      L("nar", "День 6."),
      W(800),
      L("nar", "Последний день нашего приключения."),
      W(600),
      L("gru", "Я есть Грутик.", "Сегодня самый важный день."),
      L("venom", "А мы — Веном."),
      L("nar", "Они стоят плечом к плечу. Точнее, веточкой к щупальцу. Сколько всего вы прошли вместе!"),
      L("venom", "Скоро откроется главный секрет."),
      ...
      F("wheelBroken"),
      L("nar", "Колесо заблокировано! Вчера питание восстановили, но для главного сюрприза обычной мощности не хватает."),
      ...
      L("nar", "Пройди синхронизацию всех систем, чтобы снять защиту и раскрутить колесо к главному подарку!"),
