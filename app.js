(function () {
  ...
  var dayGames = [
    ...
    { type: "photoPuzzle", mark: "04", icon: "🖤", badge: "Живой пазл", desc: "3 фазы: воля, память, согласие", kicker: "ДЕНЬ 04 · ПРОТОКОЛ «МЫ»", title: "Протокол «МЫ»", instruction: "Освободи Грутика, восстанови фотографию и сплети рамку согласия.", photo: SITE_CONFIG.couplePhoto, photos: SITE_CONFIG.day4Photos, rows: 4, cols: 3, relationship: SITE_CONFIG.relationship },
  ...
  var POSTWIN = [
    ...
    [
      ...
      L("nar", "На восстановленном портрете — Вадим и Сонечка с букетом и праздничными колпаками. На нижнем краю мягко загорается дата: 24.07.24."),
